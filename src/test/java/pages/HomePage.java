...
public class HomePage {
    ...
    String buscaProduto = "//input[@id='search_query_top']"; //Item a ser buscado
    ...
    String mensagemBusca = "//p[contains(text(),'SEARCH  PRINTED DRESS')]";
    ...
    public void pesquisarItem (){
        ...
        driver.findElement(By.xpath(buscaProduto)).sendKeys("Printed Dress");
               }
    ...
    public boolean ValidarMensagemBusca (){

       return driver.findElement(By.xpath(mensagemBusca)).isDisplayed();
    }
}
